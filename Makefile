...
release:
	@go build -ldflags="-X 'github.com/onedr0p/mockbob/cmd.versionInfo=$(TAG)' -X 'github.com/onedr0p/mockbob/cmd.gitRev=$(REV)' -X 'github.com/onedr0p/mockbob/cmd.buildDate=$(DATE)'"
